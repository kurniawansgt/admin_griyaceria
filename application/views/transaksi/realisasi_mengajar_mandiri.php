                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">REALISASI MENGAJAR (MANDIRI)</h6>
                        </div>                        
                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-4">                                        
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group date" id="datepicker" data-target-input="nearest">
                                                        <input type="text" class="form-control datetimepicker-input" data-target="#datepicker" name="tgl_realisasi" value="<?php echo date("Y-m-d");?>" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php /*<?php
                                                    echo "<br>".$kodepengajar." - ".$namapengajar;
                                                ?>
                                                <input type="hidden" name="pengajar" id="pengajar" value="<?php echo $kodepengajar."#".$namapengajar;?>">*/?>
                                                <select name="pengajar" id="pengajar" class="form-control form-control-sm select1">                                                      
                                                    <?php
                                                        foreach($pengajar as $pengajarList){
                                                            $selected = (($kodepengajar == $pengajarList->kode_pengajar) || ($realisasi[0]->kode_pengajar == $pengajarList->kode_pengajar))? "selected" : "";
                                                    ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php /*<?php                                                                                    
                                                    echo "<br>".$kode_pelajaran." - ".$mata_pelajaran[0]->nama_mapel;
                                                ?>
                                                <input type="hidden" name="mata_pelajaran" id="mata_pelajaran" value="<?php echo $kode_pelajaran."#".$mata_pelajaran[0]->nama_mapel;?>">*/?>
                                                <select name="mata_pelajaran" id="mata_pelajaran" class="form-control form-control-sm select1">  
                                                    ...
                                                    <?php
                                                        foreach($mata_pelajaran as $pelajaranList){
                                                            $selected = ($realisasi[0]->kode_mapel == $pelajaranList->kode_mapel) ? "selected" : "";
                                                    ?>
